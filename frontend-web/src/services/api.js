...
api.interceptors.response.use(
  ...
  (err) => {
    ...
    if (status === 401) {
      try {
        typeof clearSession === "function" && clearSession();
      } catch {}
...
// “Echo” para evitar cache raro de Vite en exports
export {
  usersApi as _usersApiEcho,
  labsApi as _labsApiEcho,
  periodosApi as _periodosApiEcho,
  horariosApi as _horariosApiEcho,
};
